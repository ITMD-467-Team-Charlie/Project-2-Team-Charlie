 ...
 */
exports.userRecipeList = function(req, res) {
    try {
 ...
 * @property {object} res- response object.
 */ 
 exports.saveRecepie = async function(req, res) {
    try {
 ...
 * @property {object} res- response object.
 */
exports.savedRecepies = async function(req, res) {
    try {
        var profileid = req.cookies.profile;
 ...
 * @property {object} res- response object.
 */
exports.analyzeProfile = async function(req, res) {
    try {
        var user = new Object();
        ...
        user.weight = req.body.weight * 0.45359237; // convert to kgs
